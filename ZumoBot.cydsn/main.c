...
int main()
{
    ...
    float intergalRight = 0;
    float intergalLeft = 0;
    ...
    for(;;)
    {
        ...
        switch (state) {
            case 1:
                ...
                // leftControl = getPIDValue(leftControl, button, &intergalLeft, &lastErrorLeft); 
                // printf("%f \n", leftControl);
            ...
            case 4:
                ...
                //if (left == 1 && right == 0) rightSpeed = 0.35 * speed;
                //if (right == 1 && left == 0) leftSpeed = 0.35 * speed;
                
                leftControl = getPIDValue(leftControl, (right == 0 || (right == left) ? 1 : 0), &intergalLeft, &lastErrorLeft);
                rightControl = getPIDValue(rightControl, (left == 0 || (right == left) ? 1 : 0), &intergalRight, &lastErrorRight);
                
                leftSpeed = leftControl * speed;
                rightSpeed = rightControl * speed;
                ...
                ///*if (right == 1 && left == 0)*/ leftSpeed = leftControl * speed;
                ///*if (left == 1 && right == 0)*/ rightSpeed = rightControl * speed;
